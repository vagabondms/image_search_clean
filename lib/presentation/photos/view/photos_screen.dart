...
import 'package:image_search/presentation/photos/bloc/photos_bloc.dart';
...
import 'package:image_search/presentation/widgets/hero_wrapper.dart';
...
class PhotosPage extends StatelessWidget {
  ...
  static Route<void> route() =>
      MaterialPageRoute<void>(builder: (_) => PhotosPage());
...
class PhotosScreen extends StatefulWidget {
  ...
  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (_) => const PhotosScreen());
  }
